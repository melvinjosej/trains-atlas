...
const COUNTRY_SYNONYMS = {
  ...
  'bg': ['bulgaria', 'sofia', 'septemvri', 'dobrinishte', 'rhodope', 'bulgarya'],
  'rs': ['serbia', 'belgrade', 'soko', 'falcon train', 'danube', 'serbya'],
  ...
  'kp': ['north korea', 'pyongyang', 'chollima', 'deepest subway'],
